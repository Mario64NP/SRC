...
namespace SpeedrunCommunity.Core.Services
{
    public interface IDialogService
    {
        ...
        bool ShowEditGameDialog(string currentName, string currentDeveloper, int currentReleaseYear, Platform currentPlatform, IList existingCategories, out string newName, out string newDeveloper, out int newReleaseYear, out Platform newPlatform, out IList selectedCategories);
